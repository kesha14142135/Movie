...
public class PopularMoviesPresenter implements PopularMoviesContract.Presenter, MoviesBaseDataSource.CallbackMovies  {
    ...
    @Override
    public void attachView(PopularMoviesContract.View view) {
        mView = view;
